...
[Data e ora](./data_ora/data_ora_unico.md) |(21/21)|Questo gruppo contiene funzioni per gestire dati con date e ore.|aggiornate a **QGIS 3.14**
[Espressione utente](./espressione_utente/espressione_utente_unico.md)| (?)|Questo gruppo contiene espressioni memorizzate nel profilo utente.|aggiornate a **QGIS 3.12**
...
[Geometria](./geometria/geometria_unico.md) |(124/124)|Questo gruppo contiene funzioni che operano sugli oggetti geometrici es. lunghezza, area.| aggiornate a **QGIS 3.20**
[Layer mappa](./layer_della_mappa/layer_unico.md)| (2/2)|Contiene una lista dei layer della mappa che sono disponibili nel progetto corrente.| aggiornate a **QGIS 3.6**
